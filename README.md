...
Courses table stores course information such as course name, credits, instructor, and department.
Students table stores information about students who can register for courses.
Enrollments table connects students and courses and tracks enrollment status such as Enrolled, Completed, or Withdrawn.
Course_Requirements table is used to define prerequisite relationships between courses.
